...
const RideDashboard: React.FC = () => {
  const { escrowState, walletState, transactions, getEscrowStatus } =
    useEscrow();
    ...
    return (
      <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
        <p className="text-center text-gray-600">
          Please connect your wallet to view ride details
        </p>
      </div>
    );
  }
    ...
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center py-2 border-b">
          ...
          <span
            className={`font-medium ${escrowState.isCompleted ? 'text-green-600' : 'text-blue-600'}`}
          >
        ...
        <div className="flex justify-between items-center py-2 border-b">
          ...
          <span className="font-medium">
            {formatAddress(escrowState.passenger)}
          </span>
        </div>
        ...
        <div className="flex justify-between items-center py-2 border-b">
          ...
          <span className="font-medium">
            {formatAddress(escrowState.driver)}
          </span>
        </div>
        ...
        <div className="flex justify-between items-center py-2 border-b">
          ...
          <span className="font-medium">
            {ethers.utils.formatEther(escrowState.amount)} ETH
          </span>
        </div>
